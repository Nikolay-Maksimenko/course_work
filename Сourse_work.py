...
class VKUser:
    ...
    def __init__(self, token, user_id, api_version):
        self.token = token
    ...
    def get_photos(self, count, album_id='profile'):
    ...
    def get_max_size_photos(self, photos):
        max_size_photos = []
        for photo in photos:
    ...
    def get_photos_names(self, photos):
        photo_names = []
        for photo in photos:
    ...
    def get_photos_for_upload(self, count = 5):
        number = 0
        list_photos = []
...
if __name__ == '__main__':
    ...
    yandex = YandexDiscClient('AQAAAAASWvBAAADLWx_UdUb3f0_2iOpcMWQ6JW4')
